...
juce::Array<PropertyComponent*>& PadModule::getProperties() {
    ...
    holdProp = new juce::BooleanPropertyComponent(*holdValue,"Hold","Hold");
...
void PadModule::buttonClicked (juce::Button*)
{
}

void PadModule::buttonStateChanged (juce::Button* button)
{
    if (isHold()) {
