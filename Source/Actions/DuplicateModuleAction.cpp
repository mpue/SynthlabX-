    ...
    if (module != nullptr) {
        ...
        if (module->isPrefab()) {
            ...
            if ((out = dynamic_cast<AudioOut*>(m)) != NULL) {
                ...
                String channelName = p->getOutputChannelNames().getReference(static_cast<int>(mixer->getOutputChannels().size()) - 1);
            ...
            if ((in = dynamic_cast<AudioIn*>(m)) != NULL) {
                ...
                String channelName = p->getInputChannelNames().getReference(static_cast<int>(mixer->getInputChannels().size()) - 1);
